    ...
    <div class="m-header">
      ...
      <div class="navbar-content">
        <ul class="pc-navbar">
          ...
          <li class="pc-item">
              <a href="../reservations/my-reservation.php" class="pc-link">
                  <span class="pc-micon"><i class="ti ti-list"></i></span>
                  <span class="pc-mtext">My Reservations</span>
              </a>
          </li>
          <li class="pc-item">
              <a href="../reservations/new-reservation.php" class="pc-link">
                  <span class="pc-micon"><i class="ti ti-square-plus"></i></span>
                  <span class="pc-mtext">Make new reservation</span>
              </a>
          </li>
          <li class="pc-item pc-caption">
              <label>Other</label>
          ...
          <li class="pc-item">
              <a href="../other/fields.php" class="pc-link">
                  <span class="pc-micon"><i class="ti ti-soccer-field"></i></span>
                  <span class="pc-mtext">See all fields</span>
              </a>
          </li>
          <li class="pc-item">
              <a href="../other/closing-hours.php" class="pc-link">
                  <span class="pc-micon"><i class="ti ti-alert-circle"></i></span>
                  <span class="pc-mtext">See Closing Hours</span>
              </a>
          </li>
        </ul>
      </div>
